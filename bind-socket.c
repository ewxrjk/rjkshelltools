...
static void __attribute__((noreturn)) usage(FILE *fp, int exit_status) {
  if(fputs(
"Usage:\n"
"  bind-socket [options] [--] {fd [family] [type] [address]} [--] command ...\n"
"\n"
"Options:\n"
"  -n, --no-reuse                Don't set SO_REUSEADDR\n"
"  -l SIZE, --listen SIZE        Set size of listen queue\n"
"  -p, --parents                 Create parent directories of UNIX sockets\n"
"  -m MODE, --mode MODE          Mode for created directories (octal)\n"
